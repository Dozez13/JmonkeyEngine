...
int status3 =1;
        ...
        public void onAction(String name, boolean keyPressed, float tpf) {
                ...
                case UserInput.MAPPING_COLOR_OF_FIRST:{
                       ...
                       color[0]= true;
                           ...
                           firstPerson.getBody().setColor("Color", ColorRGBA.Yellow);
                           color[0]= false;
                       }
                 ...
                 case UserInput.MAPPING_COLOR_OF_SECOND:{  
                       ...
                       color[1]= true;
                           ...
                           secondPerson.getBody().setColor("Color", ColorRGBA.Yellow);
                           color[1]= false;
                       }
                  ...
                  case UserInput.MAPPING_COLOR_OF_THIRD:{
                       ...
                       thirdPerson.getBody().setColor("Color",ColorRGBA.DarkGray);
                         color[2]= true;
                           ...
                           thirdPerson.getBody().setColor("Color", ColorRGBA.Yellow);
                          color[2]= false;
                       }
   ...
   private final ActionListener actionListener2 = new ActionListener() {
    ...
    public void simpleInitApp()  {
        ...
        firstPerson = new Person(mat.clone(),FIRST);
   
        secondPerson = new Person(mat.clone(),SECOND);
        
        thirdPerson = new Person(mat.clone(),THIRD);
